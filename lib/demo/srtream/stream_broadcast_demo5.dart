...
class StreamDemo5BroadCast extends StatelessWidget {
  const StreamDemo5BroadCast({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('StreamDemo5BroadCast'),
        elevation: 0.0,
      ),
      body: StreamDemo5BroadCastHome(),
    );
  }
}

class StreamDemo5BroadCastHome extends StatefulWidget {
  const StreamDemo5BroadCastHome({Key? key}) : super(key: key);

  @override
  _StreamDemo5BroadCastHomeState createState() => _StreamDemo5BroadCastHomeState();
}

class _StreamDemo5BroadCastHomeState extends State<StreamDemo5BroadCastHome> {
